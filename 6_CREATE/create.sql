...
INSERT INTO Ships (name, fuel, fuel_per_km, fuel_type, tank_vol, busy)
VALUES ("Korito", 1000.0, 10.0, "UltraPetrol", 2000.0, 0);

INSERT INTO Ships (name, fuel, fuel_per_km, fuel_type, tank_vol, busy)
VALUES ("Arrow4000", 10000.0, 40.0, "uran", 15000.0, 0);

INSERT INTO Tasks (ship_name, trip_from, trip_to, price, good)
VALUES ("Korito", "Solar", "Alpha_centauar", 100, 1);
